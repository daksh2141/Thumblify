           ...
           <div className={`space-y-6 ${id && 'pointer-events-none'}`}>
            ...
            <div className='space-y-2'>
              ...
              <input
                ...
                className='w-full p-2 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-pink-600'
            ...
            <div className='space-y-2'>
              ...
              <textarea value={additionalDetails} onChange={(e) => setAdditionalDetails(e.target.value)} rows ={3} className='w-full px-4 py-3 rounded-lg border border-white/10 bg-white/6 text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 resize-none focus:ring-pink-600'  placeholder="Add any specific elements, mood, or style preferences..."  />
            ...
            {!id && (
              <div>
                <button onClick={handleGenerate} className='w-full py-3 px-4 bg-pink-800 hover:bg-pink-600 text-white rounded-lg font-medium transition-colors'>
